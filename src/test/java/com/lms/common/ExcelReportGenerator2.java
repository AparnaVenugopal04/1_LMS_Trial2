...
public class ExcelReportGenerator2 {
	...
	public static void excelReport() throws IOException
	{
	...
	//Method to create workbook and sheets
	// Set a font for the headings
			...
			createHeaderRowExcel(sheet1,sheet2);
			writeDataExcel();
	...
	private static void writeDataExcel() {
	...
	private static void createHeaderRowExcel(Sheet sheet1,Sheet sheet2) 
	{
		// Create header row
